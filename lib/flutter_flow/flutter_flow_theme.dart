...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF85396F);
  late Color secondary = const Color(0xFFCDC9CA);
  late Color tertiary = const Color(0xFF254E92);
  late Color alternate = const Color(0xFFEEB352);
  late Color primaryText = const Color(0xFFCDC9CA);
